...
# 存放视频的地址
BASE_URL = 'D:\\videos\\videos\\baozi\\'
# 生成的视频地址
...
class AnimalVideo:
    ...
    def editVideo(self, path1, path2):
        ...
        txt_clip = TextClip("包子影视铺", font="./movie/movie.ttf", fontsize=19, color='white') # 包子影视铺
        txt_clip = txt_clip.set_duration(video_clip.duration)
        video = CompositeVideoClip([video_clip.set_pos((0, clip_top)),txt_clip.set_pos((5*per, 2*per))], size=video_clip.size)
        #生成视频文件
