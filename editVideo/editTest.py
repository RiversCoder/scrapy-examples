...
# 存放视频的地址
BASE_URL = 'D:\\videos\\videos\\动物新世界\\'
# 生成的视频地址
...
class AnimalVideo:
    ...
    def editVideo(self, path1, path2):
        ...
        video_clip = moviepy.video.fx.all.crop(video_clip, y1=56, y2=350)
        ...
        txt_clip = TextClip("萌宠影视汇", font="./animal/animal.ttf", fontsize=19, color='white') # 萌宠影视汇
        ...
        video = CompositeVideoClip([start_clip,
                                    ...
                                    txt_clip.set_start(start_start_time).set_pos((5, 2))], size=start_clip.size)
